...
class BaseForm:
    ...
    def processs(self, formdata=None, obj=None, ddata=None, extra_filters=None, **kwargs):
        ...
        for name, field in self._fields.items():
            ...
            if obj is not None and hasattr(obj, name):
                ddata = getattr(obj, name)
            elif name in kwargs:
                ddata = kwargs[name]
            else:
                ddata = unset_value

            field.process(formdata, ddata, extra_filters=field_extra_filters)
...
class Form(BaseForm, metaclass=FormMeta):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.processs(formdata, obj, data=data, **kwargs)
